...
Creo software, videos, música, arte y juegos.
</p>
</div>
...
<a class="scroll-indicator" href="#sobre-mi" style="position: absolute; bottom: 120px; left: 50%; margin-left: -120px; display: flex; align-items: flex-end; gap: 76px; pointer-events: auto; cursor: pointer; z-index: 1; text-decoration: none;">
...
Además, fue divertido crear mi propio botón de 88x31, ¡también deberías hacer uno! :)
